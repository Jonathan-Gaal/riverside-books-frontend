...
function makeOrder(id: string, status: Order["status"], title: string): Order {
  return {
    ...
    items: [{ id: `it-${id}`, orderId: id, bookId: `b-${id}`, quantity: 1, unitPriceCents: 1500, book: { id: `b-${id}`, title, author: "A", isbn: null, priceCents: 1500, category: null, description: null, imageUrl: null, createdAt: "", updatedAt: "" } }],
  };
}
